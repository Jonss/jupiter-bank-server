...
func NewServer(r *mux.Router, v *rest.Validator, ud user.Service, bas basic_auth.Service) *Server {
	return &Server{router: r, restValidator: v, userService: ud, basicAuthService: bas}
}
